...
func (s *StatusRequest) write(w *bytes.Buffer) error {
	return nil
}
func (s *StatusRequest) read(r *bytes.Reader) error {
	return nil
}

func (s *StatusPing) id() int { return 1 }
func (s *StatusPing) write(w *bytes.Buffer) error {
	var err error
	var tmp [8]byte
...
func (s *StatusPing) read(r *bytes.Reader) error {
	var err error
	var tmp [8]byte
