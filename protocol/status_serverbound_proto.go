...
func (s *StatusRequest) write(ww *bytes.Buffer) (err error) {
	return
}
func (s *StatusRequest) read(rr *bytes.Reader) (err error) {
	return
}

func (s *StatusPing) id() int { return 1 }
func (s *StatusPing) write(ww *bytes.Buffer) (err error) {
	var tmp [8]byte
...
func (s *StatusPing) read(rr *bytes.Reader) (err error) {
	var tmp [8]byte
