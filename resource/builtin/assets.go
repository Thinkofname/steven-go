...
func assetsStevenLogoLogoTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/steven/logo/logo.txt", size: 2016, mode: os.FileMode(420), modTime: time.Unix(1436972656, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsStevenLogoTexturesTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/steven/logo/textures.txt", size: 383, mode: os.FileMode(420), modTime: time.Unix(1436972579, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
